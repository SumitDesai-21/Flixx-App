const global = {
  ...
  api: {
    apiKey: "4ae437d3fe649ab3044706ef75d09c5f",
      ...
      <a href="tv-details.html?id=${show.id}">
        ${
          show.poster_path
            ...
            : `<img src="/flixx-app/images/no-image.jpg" class="card-img-top" alt="${show.name}" />`
        }
      </a>
      <div class="card-body">
        <h5 class="card-title">${show.name}</h5>
        <p class="card-text"><small class="text-muted">Air Date: ${
          show.first_air_date
        }</small></p>
      </div>`;
...
async function displayMovieDetails() {
  ...
  <div class="details-top">
          ...
          ${
            movie.poster_path
              ? `<img src="https://image.tmdb.org/t/p/w500${movie.poster_path}" class="card-img-top" alt="${movie.title}" />`
              : `<img src="/flixx-app/images/no-image.jpg" class="card-img-top" alt="${movie.title}" />`
          }
          </div>
          <div>
            <h2>${movie.title}</h2>
      ...
      <a href="${global.search.type}-details.html?id=${result.id}">
        ${
          result.poster_path
            ...
            : `<img src="/flixx-app/images/no-image.jpg" class="card-img-top" alt="${
                global.search.type === "movie" ? result.title : result.name
              }" />`
        }
      </a>
